...
LABEL org.label-schema.build-date=$BUILD_DATE \
      ...
      org.label-schema.description="Airflow with nosetests running on Python 3.4" \
      org.label-schema.url="https://github.com/LREN-CHUV/docker-airflow-test-py34" \
      org.label-schema.vcs-type="git" \
      org.label-schema.vcs-url="https://github.com/LREN-CHUV/docker-airflow-test-py34" \
